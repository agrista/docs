...
Agrista provides an cloud service for running agrifood ecommerce stores. At the heart of the service is an administration interface that can be used to manage farmer profiles and agribusiness processes. We provide an rapid registration tool that takes away the complexity of spatially locating farms. 

## Features

With just a few clicks, you can start managing your ecommercestore, with these amazing features out-of-the-box:
