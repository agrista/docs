...
const TITLE_WITH_TRANSLATIONS = {
  'en-ZA': 'The ERP for Agrifood Supply Chains',
  'af-ZA': 'Die ERP vir Landbou Voorsieningskettings'
}
  ...
  head: ({ title, meta }) => {
    return (
      <>
        ...
        <meta
          name='description'
          content='Agrista is a CRM & eCommerce service for agrifood supply chains. Manage farm profile data, administer site-specific procurement, and run online procurement marketplaces.'
        />
        <meta
          name='og:description'
          content='Agrista is a CRM & eCommerce service for agrifood supply chains. Manage farm profile data, administer site-specific procurement, and run online procurement marketplaces.'
        ...
        <meta name='twitter:site' content='@agrista' />
        <meta
          name='twitter:image'
          content={
            title ? title + ' - Agrista' : 'https://docs.agrista.com/assets/images/twitter-card.jpg'}
        />
        <meta name='og:title'
              content='Agrista: API for Agrifood Supply Chains' />
        <meta name='og:url' content='https://docs.agrista.com' />
        <meta
          name='og:image'
          content='https://docs.agrista.com/assets/images/twitter-card.jpg'
        />
        <meta name='apple-mobile-web-app-title' content='Agrista' />
        <link
          rel='stylesheet'
